...
for (let i of sellerno6products.data) {
    ...
    let sellerno7products = {
      data: [
        {
          productName: "Wall Decoration | رسم شخصيات بالخيط والمسمار 50سم * 50 سم",
          category: "Decor",
          productSeller: "@somaya_mahmood",
          price: "25",
          image: "seller7-1.jpg",
    
        },
        {
          productName: "Custom made art | تصاميم بالخيط والمسمار 50 سم * 30 سم",
          category: "Decor",
          productSeller: "@somaya_mahmood",
          price: "15",
          image: "seller7-2.jpg",
        ...
        {
          productName: "Custom made art | تصاميم بالخيط والمسمار 30 سم * 30 سم",
          category: "Decor",
          productSeller: "@somaya_mahmood",
          price: "10",
          image: "seller7-3.jpg",
        ...
        {
          productName: "Custom made logo  | تصاميم شعار لوجو بالخيط والمسمار 50 سم * 50 سم",
          category: "Decor",
          productSeller: "@somaya_mahmood",
          price: "18",
          image: "seller7-4.jpg",
        ...
        {
          productName: "Custom made art | تصاميم بالخيط والمسمار 50 سم * 50 سم",
          category: "Decor",
          productSeller: "@somaya_mahmood",
          price: "18",
          image: "seller7-5.jpg",
    ...
    for (let i of sellerno7products.data) {
      //Create Card
      let card = document.createElement("div");
      //Card should have category and should stay hidden initially
      card.classList.add("card", i.category, "hide");
      ...
      card.appendChild(container);
      document.getElementById("sellerno7products").appendChild(card);
      card.onclick = function() {
        window.location.href = 'https://www.instagram.com/somaya_mahmood/?hl=en';
    };
    }
